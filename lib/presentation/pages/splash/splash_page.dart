            ...
            if (_showLogo)
              Center(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: isSmallScreen ? 280 : (isLargeScreen ? 450 : 384)), // Top padding from Figma
                      ...
                      builder: (context, child) {
                        return Transform.scale(
                          ...
                          child: Opacity(
                            ...
                            child: Container(
                              width: isSmallScreen ? 100 : (isLargeScreen ? 150 : 124),
                              height: isSmallScreen ? 104 : (isLargeScreen ? 156 : 129),
                              child: Image.asset(
                    ...
                    Padding(
                      padding: EdgeInsets.only(bottom: isSmallScreen ? 30 : (isLargeScreen ? 50 : 39)), // Bottom padding from Figma
                      child: RichText(
                        text: TextSpan(
                          children: [
                            TextSpan(
            ...
            if (_showText)
              Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    SizedBox(height: isSmallScreen ? 320 : (isLargeScreen ? 520 : 436)), // Top padding from Figma V2
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: 'Vive',
                                style: TextStyle(
                                  fontSize: isSmallScreen ? 28 : (isLargeScreen ? 42 : 35),
                    ...
                    SizedBox(height: isSmallScreen ? 6 : (isLargeScreen ? 12 : 8)),
