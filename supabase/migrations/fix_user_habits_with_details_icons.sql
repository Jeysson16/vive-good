-- Fix get_user_habits_with_details to ensure icons are properly returned
-- This stored procedure is used by "Mis Hábitos" screen
...
BEGIN
  ...
  SELECT 
    ...
    -- FIXED: Ensure icons are always returned, never null
    ...
    -- Check if completed today using user_habit_logs
    CASE 
...
-- Comment
COMMENT ON FUNCTION get_user_habits_with_details(UUID, UUID) IS 'CORREGIDO: Obtiene user_habits del usuario con iconos garantizados para la pantalla Mis Hábitos';