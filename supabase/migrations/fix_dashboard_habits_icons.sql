-- Fix dashboard habits to include habit icons
-- Drop and recreate function to add icon fields
...
-- Comment
COMMENT ON FUNCTION get_dashboard_habits(UUID, DATE) IS 'Obtiene todos los hábitos del usuario para el dashboard con información completa de progreso y estadísticas, incluyendo iconos específicos de cada hábito';