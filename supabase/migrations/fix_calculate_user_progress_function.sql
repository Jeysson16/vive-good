-- Fix calculate_user_progress function to use correct columns
-- This migration updates the function to work with existing user_habits and user_habit_logs tables
